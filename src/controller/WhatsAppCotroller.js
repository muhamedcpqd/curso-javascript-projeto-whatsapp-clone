...
export class WhatsAppController{
    ...
    initContacts() {
        ...
        this._user.on('contactschange', (docs, filter) =>{
            ...
            docs.forEach(doc => {
                ...
                if (filter != '') {
                    ...
                    for (let index = 0; index < filter.length; index++) {
                        if(contact.name.toLowerCase()[index] != filter.toLowerCase()[index]) {
    ...
    setActiveChat(contact) {
        ...
        Message.getRef(this._contactActive.chatId).orderBy('timeStamp').onSnapshot(docs =>{
            ...
            docs.forEach(doc => {
                ...
                if(!this.el.panelMessagesContainer.querySelector(`#s${data.id}`)) {
                    ...
                    let msgEl = this.el.panelMessagesContainer.querySelector(`#s${data.id}`);
